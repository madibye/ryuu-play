...
import { PowerType, StoreLike, State, StateUtils, GameError, GameMessage, ChooseAttackPrompt, Player, EnergyMap, Card } from '../../game';
...
export class MarshadowGX extends PokemonCard {
  ...
  private checkAttack(state: State, store: StoreLike, player: Player,
    ...
    if (
      !(card instanceof PokemonCard) || (card instanceof MarshadowGX) ||
